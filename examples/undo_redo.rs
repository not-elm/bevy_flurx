...
//                         undo.write(RequestUndo::To(act.clone()));
//                     }
//                 }
...
//                         .min_size(size);
//                     if ui.add(button).clicked() {
//                         redo.write(RequestRedo::To(act.clone()));
//                     }
//                 }
//             });
//         });
...
//             let start = m.single().unwrap().translation;
...
//             sprite.single_mut().unwrap().color = color;
//         },
//     )
// }
